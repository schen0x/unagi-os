...
gdb -ex "target remote 127.0.0.1:1234" -ex "add-symbol-file ./build/kernel.elf ${TEXT_START}" -ex "b *KernelMain" -ex "b *KernelMainNewStack" -ex "layout split" -ex "b *debug_break" -ex "c"
# -ex "set logging on" -ex "watch xhc.cap_"
